 ...
 * meaning when one member plays it will continue to play its' note until it is done
...
public class Member implements Runnable{
    ...
    private Note note; // one note in their left hand
     ...
     * *Note that a member's bell note contains an arbitrary note duration, but the duration will change throughout the song
     * @param name
     * @param note
     * @param audioFormat
     */
